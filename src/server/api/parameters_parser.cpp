...
#include "server/api/journey_parameter_grammar.hpp"
...
using is_grammar_t =
    std::integral_constant<bool,
                           std::is_same<RouteParametersGrammar<>, T>::value ||
                               ...
                               std::is_same<JourneyParametersGrammar<>, T>::value ||
...
template <>
boost::optional<engine::api::JourneyParameters> parseParameters(std::string::iterator &iter,
                                                              const std::string::iterator end)
{
    return detail::parseParameters<engine::api::JourneyParameters, JourneyParametersGrammar<>>(iter,
                                                                                           end);
}
